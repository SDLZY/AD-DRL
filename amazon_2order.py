...
class AmazonDataset(Dataset):
    def __init__(self, path, split, dataset_name, attribute_dataset, supl_dataset, n_negative=4, check_negative=True):
        '''
        Amazon Dataset
        ...
        print(len(self.attribute_label))
    ...
    def load_features(self,data_path):
        ...
        if self.dataset_name == 'ToysGames' and self.supl_dataset[-4:] == '1024':
            print('################ We are using new ToysGames 1024 dim review features! ######################')
            doc2vec_model = np.load(os.path.join(data_path, 'review_1024.npz'), allow_pickle=True)['arr_0'].item()
        else:
        ...
        # with codecs.open('/home/share/lizhenyang/DMRL_attribute/Result/DMRL_Factor_Attribute_Sports/0421_brand/FactorAttributeNceNegBrand_neg8_embdim160_lr1_factor5_decayr平方100000_decayf500000_decaya1000000_decayn1000_weidecay0/asin_i_dic.json', 'w',
        #                  encoding='utf-8') as f:
        #     json.dump(self.asin_i_dic, f, ensure_ascii=False, indent=4)
